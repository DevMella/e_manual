<?php
    ...
    if (isset($_POST['update_profile'])) {
        ...
        $update = mysqli_query($conn, "UPDATE `lecturer` SET `name`='$name', `department`='$department', `faculty`='$faculty' WHERE `email` = '$email'");
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col col-lg-6 col-12">
                                            ...
                                            <input type="text" placeholder="<?php echo $signin['name']?>" name="name" id="">
                                        </div>
                                        <div class="col col-lg-6 col-12">
                                            <label for="" class="mt-3">Email</label> <br>
                                            <input type="email" readonly placeholder="<?php echo $signin['email']?>" name="email" id="">
                                        </div>
                                    </div>
                                    <div class="row mt-5">
                                        <div class="col col-lg-6 col-12">
                                            <label for="" class="mt-3">Department</label> <br>
                                            <input type="text" placeholder="<?php echo $signin['department']?>" name="department" id="">
                                        </div>
                                        <div class="col col-lg-6 col-12">
                                            <label for="" class="mt-3">Faculty</label> <br>
                                            <input type="text" placeholder="<?php echo $signin['faculty']?>" name="faculty" id="">
                                        </div>
                                    </div>
                                    <button class="but" name="update_profile">Update</button>
                                </form>
                            </div>
                                ...
                                <form action="">
                                    <div class="row">
                                        <div class="col col-lg-12 col-12 mt-3">
                                            ...
                                            <input type="password" placeholder="<?php echo $signin['password']?>" name="" id="">
                                        </div>
                                        <div class="col col-lg-12 col-12 mt-3">
