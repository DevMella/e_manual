    ...
    <div class="all">
        <div class="body">
            <div class="side d-lg-block d-none">
                ...
                <a href="acess.php">
                    <div class="icon d-flex gap-2 mb-3" id="acess">
                    ...
                    <div class="tee">
                        ...
                        <div class="res">
                            <div class="row mt-3">
                                ...
                                <div class="col cl-lg-2 d-lg-block d-none">Amount</div>
                                <div class="col col-lg-3 d-lg-block d-none">Payment Mode</div>
                            </div>
                            <?php while ($picked = mysqli_fetch_assoc( $content)): ?>
                                <div class="row mt-3">
                                <div class="col col-lg-7 col-10">
                                    <div class="d-flex gap-2 align-items-center">
                                        <div class="wee" style="width: 50px;">
                                            <img width="100%" style="object-fit: cover;height: 60px; margin-bottom: 10px; border-radius: 5px;"  src="<?php echo htmlspecialchars($picked['manual_image']); ?>" alt="Book Image">
                                        </div>
                                        <h6><?php echo htmlspecialchars($picked['course_name']); ?></h6>
                                    </div>
                                </div>
                                <div class="col cl-lg-2 col-2"><?php echo htmlspecialchars($picked['amount']); ?></div>
                                <div class="col col-lg-3 d-lg-block d-none">Paystack</div>
                            </div>
                            <?php endwhile; ?>
