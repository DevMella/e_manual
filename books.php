                                ...
                                <div class="col col-lg-4">
                                    <div class="son mb-4">
                                        <div style="width: 100%; height:250px;">
                                            <img width="100%" style="height:250px;object-fit:cover;" src="lecturer/<?php echo htmlspecialchars($picked['manual_image']); ?>" alt="Book Image">
                                        </div>
                                        ...
                                        <form action="transaction.php" method="GET">
                                            <input type="hidden" name="image" value="<?php echo htmlspecialchars($picked['manual_image']); ?>">
                                            <input type="hidden" name="name" value="<?php echo htmlspecialchars($picked['course_name']); ?>">
                                            <input type="hidden" name="code" value="<?php echo htmlspecialchars($picked['course_code']); ?>">
                                            <input type="hidden" name="price" value="<?php echo htmlspecialchars($picked['amount']); ?>">
                                            <input type="hidden" name="pdf" value="<?php echo htmlspecialchars($picked['manual_pdf']); ?>">
                                            <button type="submit" class="but mt-3">Purchase now</button>
                                        </form>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                    ...
                    <div class="tat">
                        <div class="d-lg-block d-none">
                            ...
                            <div class="mus d-flex  justify-content-between align-items-center">
                                <div>
                                    <p class="bas">Matric Number :<?php echo $signin['matric']?></p>
                                    <p class="bad">Faculty:<?php echo $signin['faculty']?></p>
