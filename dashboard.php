                    ...
                    <div class="tee">
                        <div class="swiper mySwiper">
                            ...
                            <?php while ($picked = mysqli_fetch_assoc($content)): ?>
                                <div class="swiper-slide">
                                    <div class="lat">
                                        <div style="width: 100%; ">
                                            <img width="100%" style="object-fit:cover;" src="lecturer/<?php echo htmlspecialchars($picked['manual_image']); ?>" alt="Book Image">
                                        </div>
                                        <h6><?php echo htmlspecialchars($picked['course_name']); ?></h6>
                                        <div class="d-flex justify-content-between">
                                            <h6><?php echo htmlspecialchars($picked['lecturer_name']); ?></h6>
                                        </div>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="row mt-3">
                                <div class="col col-lg-5 col-7">
                                    <div class="d-flex gap-2">
                                        <div class="box"><i class="bi bi-code-slash"></i></div>
                                        <h6 class="mt-2">Introduction to C++</h6>
                                    </div>
                                </div>
                                <div class="col col-lg-3 d-lg-block d-none">
                                    <h6>13th August,2024</h6>
                                </div>
                                <div class="col col-lg-2 ">
                                    <h6>₦1,500</h6>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col col-lg-5 col-7">
                                    <div class="d-flex gap-2 align-items-center">
                                        <div class="box bix"><i class="bi bi-database"></i></div>
                                        <h6 class="mt-2">System Database Design</h6>
                                    </div>
                                </div>
                                <div class="col col-lg-3 d-lg-block d-none">
                                    <h6>13th August,2024</h6>
                            ...
                            <div class="row mt-3">
                                <div class="col col-lg-5 col-7">
                                    <div class="d-flex gap-2">
                                        <div class="box pur"><i class="bi bi-motherboard"></i></div>
                                        <h6 class="mt-2">Computer Hardware</h6>
                                    </div>
                                </div>
                                <div class="col col-lg-3 d-lg-block d-none">
                                    <h6>13th August,2024</h6>
                            ...
                            <div class="row mt-3">
                                <div class="col col-lg-5 col-7">
                                    <div class="d-flex gap-2">
                                        <div class="box ora"><i class="bi bi-pc-display-horizontal"></i></i></div>
                                        <h6 class="mt-2">Artificial intelligence</h6>
                                    </div>
                                </div>
                                <div class="col col-lg-3 d-lg-block d-none">
                                    <h6>13th August,2024</h6>
                        ...
                        <div class="d-lg-block d-none">
                            ...
                            <div class="mus d-flex  justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p>Faculty:<?php echo $signin['faculty']?></p>
